      ...
      <>
        ...
        <div className="container mx-auto px-4 py-8 min-h-[calc(100vh-64px-200px)]">
          <div className="text-center py-20">
            ...
            <Link href="/planner/my" className="mt-4 inline-block text-primary hover:underline">
              목록으로 돌아가기
            </Link>
          </div>
        </div>
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl min-h-[calc(100vh-64px-200px)]">
          ...
          {canEdit && (
            <div className="mt-4 pt-4 border-t border-gray-100 flex gap-3">
              <Link
                ...
                className="px-4 py-2 bg-primary text-white text-sm font-medium rounded-lg hover:bg-primary-800 transition-colors"
              >
                수정하기
              </Link>
              <button
        ...
        {application.adminResponse && (
          <div className="bg-primary-50 rounded-2xl border border-primary-100 p-6 md:p-8 mb-6">
            <h2 className="text-lg font-bold text-primary mb-4 pb-3 border-b border-primary-200">관리자 답변</h2>
        ...
        <div className="flex justify-center gap-4 pt-4">
          ...
          <Link
            href="/planner/create"
            className="px-8 py-3 bg-primary text-white font-medium rounded-lg hover:bg-primary-800 transition-colors"
          >
            새 상담 신청
          </Link>
        </div>
