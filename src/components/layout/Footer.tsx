        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="flex items-center gap-4 text-gray-400">
              <li>
                <a aria-label="카카오톡" className="text-blue-100 hover:text-white transition-colors duration-200">
              ...
              <li>
                <a aria-label="유튜브" className="text-blue-100 hover:text-white transition-colors duration-200">
                  <svg fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6">
              ...
              <li>
                <a aria-label="인스타그램" className="text-blue-100 hover:text-white transition-colors duration-200">
                  <svg fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6">
