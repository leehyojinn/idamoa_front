    ...
    <footer className="bg-secondary text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="font-semibold mb-4">커뮤니티 바로가기</h4>
            <ul className="flex items-center gap-4 text-gray-400">
              <li>
                <span title="카카오톡" className="text-primary-100 hover:text-white transition-colors duration-200 inline-block cursor-not-allowed">
              ...
              <li>
                <span title="유튜브" className="text-primary-100 hover:text-white transition-colors duration-200 inline-block cursor-not-allowed">
                  <svg fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6">
              ...
              <li>
                <span title="인스타그램" className="text-primary-100 hover:text-white transition-colors duration-200 inline-block cursor-not-allowed">
                  <svg fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6">
